...
<p align="center">
  <a href="https://github.com/Ikumyon/kancolle-notify/releases/latest"><img src="https://img.shields.io/badge/version-0.9.3RC-blue.svg" alt="Version"></a>
...
- ⏱️ **充実のタイマー・ステータス管理**
  ...
  - 疲労度（cond値）の 3分周期自然回復（上限49）および母港給糧艦システム（上限54）の高精度シミュレーション計算
